...
public abstract class GenericDAL<T> {
    ...
    /**
     * entity class type of this DAL
     */
    private final Class<T> entityClass;
    
    /**
     * entity manager used in this DAL
     */
    private EntityManager em;

    /**
     * create a DAL and initialize the Entity class type
     * @param entityClass 
     */
     ...
     * @param parameters - parameters to be set in named query,
     * a map of keys (name place holder in named query) and value (value to replace the place holder in named query)
     * @return one result
     */
