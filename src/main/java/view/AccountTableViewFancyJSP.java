...
public class AccountTableViewFancyJSP extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
            throws ServletException, IOException {
        log("POST");
        //get the path of request, for example this page will likely be /AccountTableViewFancyJSP
        //String path = req.getServletPath();
        //get all the parameters in request as a map. in this map keys will be the html tag names and values will be the html tag values
